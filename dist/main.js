...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _menu_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./menu/menu.js */ \"./menu/menu.js\");\n\r\n\r\ndocument.addEventListener('DOMContentLoaded', () => {\r\n    let flag__module__swiper = false;\r\n    let flag__module__desktop = false;\r\n    let module__swiper;\r\n    let module__desktop;\r\n\r\n    async function setListener() {\r\n\r\n        if (window.innerWidth < 767 && flag__module__swiper === false) {\r\n            module__desktop ? module__desktop.destroy() : null;\r\n            flag__module__desktop = false;\r\n            flag__module__swiper = true;\r\n            module__swiper = (await (Promise.all(/*! import() */[__webpack_require__.e(\"vendors-node_modules_swiper_modules_index_mjs-node_modules_swiper_swiper_mjs\"), __webpack_require__.e(\"brends_swiper_js\")]).then(__webpack_require__.bind(__webpack_require__, /*! ./brends/swiper.js */ \"./brends/swiper.js\")))).default();\r\n\r\n        } else if (window.innerWidth > 767 && flag__module__desktop === false) {\r\n            module__swiper ? module__swiper.destroy() : null;\r\n            flag__module__swiper = false;\r\n            flag__module__desktop = true;\r\n            module__desktop = (await (__webpack_require__.e(/*! import() */ \"brends_view_element_js\").then(__webpack_require__.bind(__webpack_require__, /*! ./brends/view_element.js */ \"./brends/view_element.js\")))).default();\r\n        }\r\n    }\r\n\r\n    setListener();\r\n    (0,_menu_menu_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n    window.addEventListener('resize', setListener);\r\n})\r\n\r\n\n\n//# sourceURL=webpack:///./script.js?");
